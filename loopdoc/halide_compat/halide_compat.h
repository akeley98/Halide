...
// examples.
//
// The examples use `collapses(f, {vars...})` to annotate which loops Halide
// elides (point loops, extent 1). That annotation only matters to
...
inline void collapses(const Func &, std::initializer_list<Var>)
{
}
